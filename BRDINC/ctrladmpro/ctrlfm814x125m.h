/*
 ****************** File CtrlFm814x125m.h *************************
 *
 *  Definitions of user application interface
 *	structures and constants
 *	for BRD_ctrl : FM814x125M section
 *
...
#ifndef _CTRL_FM814x125M_H
 #define _CTRL_FM814x125M_H
...
typedef enum _FM814X125M_NUM_CMD
{
	FM814X125Mcmd_SETMU		= 64,
	FM814X125Mcmd_GETMU		= 65,
} FM814X125M_NUM_CMD;

typedef struct _FM814X125MSRV_MU {
	U32		size;					// sizeof(FM814X125MSRV_MU)
...
} FM814X125MSRV_MU, *PFM814X125MSRV_MU;

#pragma pack(pop)    

#endif // _CTRL_FM814x125M_H
